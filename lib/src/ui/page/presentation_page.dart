...
import 'package:app_arwise/src/utils/url_images.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              height:150,
              width: 150,
              child:Image.asset('assets/img/logos/logoAzulUnidadEducativa.png'),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                SizedBox(
                  height:100,
                  width: 100,
                  child:Image.asset('assets/img/logos/logoCarreraPlomo.png'),
                ),
                SizedBox(
                  height:100,
                  width: 100,
                  child:Image.asset('assets/img/logos/logoPlomoUnidadEducativa.png'),
                ),
